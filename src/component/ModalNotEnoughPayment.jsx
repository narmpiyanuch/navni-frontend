...
export default function ModalNotEnoughPayment({
  open,
  onClose,
  totalPrice,
  wallet,
              ...
              <div className="flex flex-col items-center justify-start h-[320px] w-[280px] bg-MonoColor-50 rounded-3xl gap-4">
                ...
                <div className="flex gap-4 p-2">
                  <div className="flex flex-col items-center justify-center gap-4 bg-Primary-light w-[100px] h-[96px] rounded-2xl">
                    <div className="relative">
                      <div className="absolute left-[72px] top-[-20px] flex justify-center items-center w-[28px] h-[28px] bg-Error-main rounded-full ">
                        <span className="material-symbols-outlined text-[18px] text-MonoColor-50">
                          priority_high
                        </span>
                      </div>
                  ...
                  <button
                    ...
                    className="flex flex-col items-center justify-center gap-4 bg-Primary-dark w-[100px] h-[96px] rounded-2xl active:bg-Primary-main"
                  >
                    <div className="relative">
                      <div className="flex flex-col justify-center items-center">
                        <p className="text-[16px] text-MonoColor-50 ">
                          Please!
                        </p>
                        <p className="text-[24px] text-MonoColor-50 font-semibold">
                          Top-up
                ...
                <div className="bg-Primary-lightest rounded-3xl text-MonoColor-50 py-2 px-4 text-[16px] font-normal">
                  Request a car
                </div>
              </div>
            </div>
