                            ...
                            <div className="flex gap-4 p-2">
                                <div className='flex flex-col items-center justify-center gap-4 bg-Primary-main w-[180px] h-[96px] rounded-2xl'>
                                    <div className="flex flex-col justify-center items-center">
                                        ...
                                        <p className="text-[12px] text-MonoColor-50">Balance 100 NP</p>
                                    </div>
                                </div>
                            </div>
                            <button className='bg-Primary-dark rounded-3xl text-MonoColor-50 py-2 px-4 text-[16px] font-normal  active:text-MonoColor-600 active:bg-Primary-light'>Request a car</button>
                        </div>
                    </div>
                </div>
            </>)}
