        ...
        <div className="flex flex-col gap-4 pt-8">
          ...
          <button className=" flex w-[280px] h-[120px] bg-MonoColor-50 justify-start items-center rounded-2xl border-2 border-Primary-dark  active:bg-Primary-lightest">
            <div className="flex items-start">
              ...
              <p className="pl-8 font-medium text-[16px] text-Primary-darker active:text-MonoColor-600">
                QR Code
              </p>
            </div>
          </button>
          <button className=" flex w-[280px] h-[120px] bg-MonoColor-50 justify-start items-center rounded-2xl border-2 border-Primary-dark  active:bg-Primary-lightest">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="pl-8 font-medium text-[12px] text-MonoColor-400 active:text-MonoColor-600">
                  VISA, MasterCard, JCB
                </p>
              </div>
            </div>
