        ...
        <div className='flex flex-col m-auto items-center justify-center bg-Primary-main h-screen w-screen gap-2'>
            <div className='flex flex-col fixed bottom-[54%] items-center '>
                <div className='flex gap-4 items-center'>
                    <img src={defaultAvatar} className='rounded-full aspect-square w-[60px] border-4 border-MonoColor-50 drop-shadow-lg' />
                    <div className=' flex-shrink'>
                        <div className='flex justify-between items-center'>
                            <p className='text-[18px] text-MonoColor-50'>Hello (First name)</p>
                            <p className='text-[12px] text-OtherColor-yellow'>Edit Profile</p>
                        </div>
                ...
                <div className='pt-[20px]'>
                    <div className='w-[200px] h-[200px] bg-MonoColor-50 rounded-full relative overflow-hidden flex flex-col items-center justify-start '>
                        ...
                        <div className='flex items-center justify-center'>
                            ...
                            <button className='w-[28px] h-[28px] rounded-full absolute bg-MonoColor-50 bottom-[16px] text-center text-Primary-dark font-semibold text-[20px]'>+</button>
                        </div>
                    </div>
                </div>
            </div>
            <div className='fixed top-[42%] items-center justify-start pt-6 bg-MonoColor-50 h-full w-screen rounded-[40px_40px_0px_0px] mt-[60px]'>
                <div className='flex items-center justify-center pt-4'>
                    <div className='flex  items-center bg-Primary-dark w-[320px] h-[88px] rounded-3xl gap-10 pl-6'>
                ...
                <div className='flex gap-10 items-center justify-center mt-10'>
                    <div className='flex flex-col justify-center items-center relative w-[132px] h-[100px] rounded-3xl bg-Primary-light'>
                        ...
                        <p className='text-MonoColor-50 text-[20px] font-semibold'>History</p>
                    </div>
                    <div className='flex flex-col justify-center items-center relative w-[132px] h-[100px] rounded-3xl bg-Primary-light'>
                        <div className='flex justify-center items-center w-[64px] h-[64px] bg-MonoColor-50 rounded-full absolute top-[-30px] border-4  border-Primary-light'>
                            <img src={information} alt='tuktuk' className='w-[40px]' />
                        </div>
                        <p className='text-MonoColor-50 text-[20px] font-semibold'>Information</p>
                    </div>
                </div>
                <div className='flex gap-10 items-center justify-center mt-8'>
                    <div className='flex flex-col justify-center items-center relative w-[320px] h-[40px] rounded-3xl bg-Secondary-main'>
