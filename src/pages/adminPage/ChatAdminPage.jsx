...
export default function ChatAdminPage() {
    return (
        <div className='flex flex-col w-screen h-screen'>
            <HeaderAdminPage />
            <div className='flex pt-[3%] justify-center min-h-[64%] z-10'>
                <div className='grid grid-cols-3 w-[1200px] gap-4'>
                    ...
                    <form className='col-span-2 relative bg-MonoColor-50 border-4 border-Primary-dark rounded-3xl'>
                        <div>
                            <div className='flex items-center sticky top-0 left-0 right-0  w-[80%] h-[40px] border-4 border-Primary-light rounded-2xl '>
                                <input type='text' className='outline-none bg-' />
