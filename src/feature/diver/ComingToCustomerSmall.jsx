...
export default function ComingToCustomerSmall({ setIsOpen, setIsPickUp }) {
    ...
    return (
        <div className="flex fixed top-[24%] flex-col items-center justify-start bg-MonoColor-50 drop-shadow-xl w-[360px] h-[100px] rounded-[40px_40px_40px_40px] drop-shadow-[0_35px_35px_rgba(0,0,0,0.25) overflow-hidden px-10">
            ...
            <div className="flex fixed bottom-0 flex-col items-center justify-start bg-Primary-darker w-screen h-[40px] rounded-[0px_0px_40px_40px]" >
                <button onClick={() => setIsOpen(true)} className='flex justify-end w-full pr-10'>
                    <span class="material-symbols-outlined text-MonoColor-50 text-[40px] rotate-180"> expand_less</span>
                </button>
            </div>
        </div >
    )
