export default function ComingToCustomerSmall({
    setIsOpen,
    setIsPickUp,
    bookingItem,
}) {
    return (
        <div className="flex fixed top-[24%] flex-col items-center justify-start bg-MonoColor-50 drop-shadow-xl w-[360px] h-[100px] rounded-[40px_40px_40px_40px] drop-shadow-[0_35px_35px_rgba(0,0,0,0.25) overflow-hidden px-10">
            <div className="fixed flex items-start pt-6 justify-between  h-full rounded-[20px_20px_0px_0px]] w-[360px] pr-10">
                ...
                <div className="fixed right-4 top-4 flex-col gap-2 justify-center items-center">
                    <button
                        onClick={() => setIsPickUp(true)}
                        className="w-[100px] py-2 bg-OtherColor-darkGreen text-MonoColor-50 rounded-xl text-[14px] active:bg-OtherColor-lightGreen active:text-MonoColor-700"
                    >
            ...
            <div className="flex fixed bottom-0 flex-col items-center justify-start bg-Primary-darker w-screen h-[36px] rounded-[0px_0px_40px_40px]">
                <button
                    ...
                    className="flex justify-end w-full pr-10"
                >
                    <span className="material-symbols-outlined text-MonoColor-50 text-[40px] rotate-180">
                        {" "}
                        expand_less
                    </span>
                </button>
