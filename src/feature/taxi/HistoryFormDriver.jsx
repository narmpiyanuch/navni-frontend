...
export default function HistoryFormDriver() {
    return (
        <>
            {hittorydriver.map(el =>
                <div key={el.id} className="flex flex-col gap-2 justify-center items-center">
                    <div className="flex w-screen pl-10 items-center justify-start">
                        <p className="text-[14px] text-MonoColor-400 ">{el.datetime}</p>
                    </div>
                    <div className="grid grid-cols-4 justify-center items-center">
                        ...
                        <div className="flex flex-col items- justify-start gap-2 w-[200px] col-start-2 col-span-2">
                            <div className="flex gap-6">
                                ...
                                <p className="text-[14px] text-MonoColor-400">{el.from}</p>
                            </div>
                            <div className='flex gap-10'>
                                <p className="text-[14px] text-MonoColor-400">To</p>
                                <p className="text-[14px] text-MonoColor-400">{el.to}</p>
                            </div>
                        </div>
                        <div className="flex flex-col justify-center items-center gap-2">
                            <p className="text-[12px] text-MonoColor-400">Fere</p>
                            <p className="text-[14px] text-Primary-dark text-center">{el.fera}</p>
                        </div>
                    </div >
